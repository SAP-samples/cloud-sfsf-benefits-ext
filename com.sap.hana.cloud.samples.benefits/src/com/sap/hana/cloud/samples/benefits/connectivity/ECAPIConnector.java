...
public class ECAPIConnector {
    ...
    public BenefitsAmount getUserBenefitsAmount(String userId) throws IOException, InvalidResponseException {
        String userBenefitsAmountJson = executeGET(getUserBenefitsAmountQuery(userId));
    ...
    public List<BenefitsAmount> getEmployeesBenefitsAmount(String hrUserId) throws IOException, InvalidResponseException {
        String userBenefitsAmountJson = executeGET(getEmployeesBenefitsAmountQuery(hrUserId));
